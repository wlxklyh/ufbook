...
### 📝 写作流程
1. 编辑 `docs/章节名/文章.md`
2. 创建同名文件夹 `docs/章节名/文章名/`
3. 图片放在 `docs/章节名/文章名/` 中
4. 保存文件（自动热重载）
...
**示例**：编辑 `docs/performance/locke-kingdom-mobile-pipeline.md`
- 图片放在：`docs/performance/locke-kingdom-mobile-pipeline/01-demo.png`
- 引用方式：`![演示](locke-kingdom-mobile-pipeline/01-demo.png)`
