...
![Joe Andreson自我介绍](qualcomm-frame-interpolation/Screenshots/018_plus0.0s.png)
...
![下一代HMI的关键特性](qualcomm-frame-interpolation/Screenshots/032_plus0.0s.png)
...
![MultiWorld架构示意](qualcomm-frame-interpolation/Screenshots/094_plus0.0s.png)
...
![仪表盘与中控屏同时运行](qualcomm-frame-interpolation/Screenshots/106_plus0.0s.png)

#### 2. 自动化性能测试：CI/CD 流水线中的性能守护者

![Unreal Insights工具界面](qualcomm-frame-interpolation/Screenshots/111_plus0.0s.png)
...
![自动化性能测试流程](qualcomm-frame-interpolation/Screenshots/124_plus0.0s.png)
...
![API Gear工作流程](qualcomm-frame-interpolation/Screenshots/139_plus0.0s.png)
...
![生成的蓝图节点示例](qualcomm-frame-interpolation/Screenshots/160_plus0.0s.png)
...
![API Gear仿真工具](qualcomm-frame-interpolation/Screenshots/155_plus0.0s.png)
...
![HMI模板仪表盘示例](qualcomm-frame-interpolation/Screenshots/165_plus0.0s.png)
...
![地图组件演示](qualcomm-frame-interpolation/Screenshots/170_plus0.0s.png)
...
![设计驱动开发工作流](qualcomm-frame-interpolation/Screenshots/176_plus0.0s.png)
...
![Rivian HMI设计](qualcomm-frame-interpolation/Screenshots/189_plus0.0s.png)
...
![Niagara粒子系统](qualcomm-frame-interpolation/Screenshots/192_plus0.0s.png)
...
![仪表盘运行状态](qualcomm-frame-interpolation/Screenshots/197_plus0.0s.png)
...
![外部服务仿真](qualcomm-frame-interpolation/Screenshots/231_plus0.0s.png)
...
![Python服务演示](qualcomm-frame-interpolation/Screenshots/247_plus0.0s.png)
